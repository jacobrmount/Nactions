...
public class NotionProperty: Codable {
    ...
    required public init(from decoder: Decoder) throws {
        ...
        // Decode the appropriate property value based on type
...
public class NotionBlock: Codable {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        id = try container.decode(String.self, forKey: .id)
        parent = try container.decode(NotionBlockParent.self, forKey: .parent)
...
public class NotionObject: Codable {
    ...
    // Could be a database, page, or other notion object
    // We'll handle specific parsing in the client
}
