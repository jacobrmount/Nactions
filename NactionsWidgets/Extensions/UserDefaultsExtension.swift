...
extension UserDefaults {
    ...
    func getCachedTasks(tokenID: String, databaseID: String) -> [NactionsShared.TaskItem]? {
        ...
        return taskDicts.compactMap { dict -> NactionsShared.TaskItem? in
            ...
            return NactionsShared.TaskItem(id: id, title: title, isCompleted: isCompleted, dueDate: dueDate)
        }
    }
    ...
    func getCachedProgress(tokenID: String, databaseID: String) -> NactionsShared.ProgressData? {
        ...
        return NactionsShared.ProgressData(title: title, currentValue: currentValue, targetValue: targetValue)
    }
}
